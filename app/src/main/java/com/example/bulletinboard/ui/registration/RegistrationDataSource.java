...
public class RegistrationDataSource {
    ...
    public void register(String email, String password,String username, RegistrationCallback registrationCallback) {
        ...
        call.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    registrationCallback.onRegistrationFailure(new Exception("Login failed: "), errorMessage);
                }
            }

            @Override
            public void onFailure(Call<User> call, Throwable t) {
                registrationCallback.onRegistrationFailure(t, "failed");
            }
        });
    }
